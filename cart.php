...
<div id="page-content" class="single-page">
    <div class="container">
        ...
        if (isset($_SESSION['cart']) && is_array($_SESSION['cart']) && count($_SESSION['cart']) > 0) {
            // Chuyển mảng ID sản phẩm thành chuỗi phân cách bởi dấu phẩy
            $item = array_keys($_SESSION['cart']);  // Lấy các ID sản phẩm từ giỏ hàng
            $str = implode(",", $item);  // Tạo chuỗi các ID sản phẩm
                ...
                <div class="product well">
                    ...
                    <div class="col-md-9">
                        <div class="caption">
                            ...
                            if ($s["KhuyenMai"] == true) {
                            ?>
                            <label style="color:red">Thành tiền: <?php echo $_SESSION['cart'][$s["ID"]] * $s["giakhuyenmai"] ?>.000</label>
                            <?php
                            }
                            ?>
                            <?php
                            if ($s["KhuyenMai"] == false) {
                            ?>
                            <label style="color:red">Thành tiền: <?php echo $_SESSION['cart'][$s["ID"]] * $s["Gia"] ?>.000</label>
                            <?php
                            }
                            ?>
                        </div>
